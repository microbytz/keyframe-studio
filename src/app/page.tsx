...
export default function Home() {
  const {
    ...
    activeLayerId, setActiveLayerId, isPlaying, loopSelection, setLoopSelection,
    tool, lastBrushTool, lastShapeTool, setTool, moveMode, setMoveMode,
               ...
               <div className="space-y-3">
                 <div className="flex items-center justify-between"><Label className="text-[10px] uppercase opacity-60">Scale</Label>
                   <Select value={exportScale} onValueChange={setExportScale}>
                     <SelectTrigger className="w-24 h-8 bg-black/40 text-xs"><SelectValue /></SelectTrigger>
                     <SelectContent><SelectItem value="0.5">0.5x</SelectItem><SelectItem value="1">1.0x</SelectItem><SelectItem value="2">2.0x</SelectItem></SelectContent>
                   </Select>
                 </div>
            ...
            <div className="studio-panel bg-white/5 p-6 space-y-6">
              <div className="grid grid-cols-2 gap-6">
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between"><Label className="text-[10px] uppercase font-bold">Pressure</Label><Switch checked={pressureEnabled} onCheckedChange={setPressureEnabled} /></div>
                </div>
                <div className="space-y-4">
